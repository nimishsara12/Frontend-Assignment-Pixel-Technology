        ...
        <div>
              ...
              <div className="  dropdown-borad flex flex-col h-[70vh]  justify-between ">
                <div>
                  {boards.map((board, index) => (
                    ...
                    >
                      <img alt="board" src={boardIcon} className="  filter-white  h-4 " />{" "}
                  ...
                  >
                    <img alt="icon" src={boardIcon} className="   filter-white  h-4 " />
          ...
          {isSideBarOpen ? (
            <div
              ...
              className=" flex  items-center mt-2  absolute bottom-16  text-lg font-bold  rounded-r-full hover:text-[#635FC7] cursor-pointer mr-6 mb-8 px-9 py-41 hover:bg-[#635fc71a] dark:hover:bg-white  space-x-2 justify-center  my-4 text-gray-500 "
            >
              <img
